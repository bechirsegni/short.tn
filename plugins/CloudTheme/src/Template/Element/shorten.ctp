...
<div class="form-group">
    ...
    <?= $this->Form->button($this->Html->image('right-arrow.png'), ['class' => '']); ?>
</div>

<?php if (!$this->request->session()->read('Auth.User.id') && (bool)get_option('enable_captcha_shortlink_anonymous',
        false) && isset_captcha()
) : ?>
