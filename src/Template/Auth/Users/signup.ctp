...
<div class="form-group">
    <label><?= __("By signing up, you agree to the {0} and {1}.",
            "<a href='" . $this->Url->build('/') . 'pages/privacy' . "' target='_blank'>" . __('Terms of Service') . "</a>",
            "<a href='" . $this->Url->build('/') . 'pages/privacy' . "' target='_blank'>" . __('Privacy Policy') . "</a>") ?></label>
</div>
