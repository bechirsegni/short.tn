        ...
        <div role="tabpanel" id="general" class="tab-pane fade in active">
            ...
            <div class="row">
                ...
                <div class="col-sm-10">
                    ...
                    ?>
                    <span class="help-block"><?= __('Main domain used for all pages expect the short link page. Make sure to remove the "http" or "https" and the trailing slash (/)!. Example: <b>domain.com</b>') ?></span>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-10">
                    ...
                    ?>
                    <span class="help-block"><?= __('Add the default domain used for the short links. If it is empty, the main domain will be used. Make sure to remove the "http" or "https" and the trailing slash (/)!. Example: <b>domain.com</b>') ?></span>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-10">
                    ...
                    ?>
                    <span class="help-block"><?= __("Add the other domains(don't add the default short URL domain or the main domain) you want users to select between when short links. ex. <b>domain1.com,domain2.com</b> These domains should be parked/aliased to the main domain. Separate by comma, no spaces. Make sure to remove the 'http' or 'https' and the trailing slash (/)!") ?></span>
                </div>
            </div>
