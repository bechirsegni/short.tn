...
<div class="box box-primary">
    <div class="box-body">
        ...
        <p><?= __("If you have a website with 100's or 1000's of links you want to change over to {0} then please use the script below.",
                get_option('site_name')) ?></p>

        <p><?= __("Simply copy-and-paste the code below on to your webpage or blog and the links will be updated automatically!") ?></p>
        ...
        <script src='<?= $this->Url->build('/', true); ?>js/full-page-script.js'></script>
        <?php
        ...
        <p><?= __("Or if you wish to change every link to {0} on your website (without stating exactly which domains) please use the following code.",
                get_option('site_name')) ?></p>
