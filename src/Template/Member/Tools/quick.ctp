...
<div class="box box-primary">
    <div class="box-body">
        ...
        <p><?= __('Just copy the link below to address bar into your web browser, change last part to destination link and press ENTER. {0} will redirect you to your shortened link. Copy it wherever you want and get paid.',
        ...
        <?php if (array_key_exists(1, $allowed_ads)): ?>
            <p><?= __("If you want to use Quick Link with the interstitial advertising add the below code to the end of the URL") ?></p>
            <pre>&type=1</pre>
        <?php endif; ?>

        <?php if (array_key_exists(2, $allowed_ads)): ?>
            <p><?= __("If you want to use Quick Link with the banner advertising add the below code to the end of the URL") ?></p>
            <pre>&type=2</pre>
        <?php endif; ?>

        <?php if (array_key_exists(0, $allowed_ads)): ?>
            <p><?= __("If you want to use Quick Link without advertising add the below code to the end of the URL") ?></p>
            <pre>&type=0</pre>
        <?php endif; ?>
