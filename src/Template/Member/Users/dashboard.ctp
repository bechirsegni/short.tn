    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-red">
                <div class="inner">
                    <h3><?= (!empty($total_views)) ? display_price_currency($total_earnings / $total_views * 1000,
                            ['precision' => 2]) : 0 ?></h3>
        ...
        <div class="box-body">
            <table class="table table-hover table-striped">
                ...
                <?php foreach ($popularLinks as $link) : ?>
                    ...
                    ?>
                    <tr>
                        <td><a href="<?= $short_url ?>" target="_blank"><span
                                        class="glyphicon glyphicon-link"></span> <?= h($title) ?></a></td>
                        <td><?= $link->views ?></td>
